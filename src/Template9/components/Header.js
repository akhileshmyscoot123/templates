        ...
        <div className="div-block-23 hero">
          <div className="capsule-2 is-secondary _1">
            <div className="html-embed-14 w-embed">
              ...
              >
                <path
                  d="M8.27763 0.397949C3.81027 0.397949 0.175781 4.03244 0.175781 8.4998C0.175781 12.9672 3.81027 16.6017 8.27763 16.6017C12.745 16.6017 16.3795 12.9672 16.3795 8.4998C16.3795 4.03244 12.745 0.397949 8.27763 0.397949ZM7.46745 13.3609V9.30999H4.22671L9.08782 3.63869V7.68962H12.3286L7.46745 13.3609Z"
                  fill="#C3B378"
                  fill-opacity="0.75"
                />
              </svg>
            </div>
            <div className="capsule-text-2 text-size-14">
                ...
                <div className="hero_capsule-wrapper-2">
                  <div className="capsule-3">
                    <div className="capsule_logo-2 small w-embed">
                      ...
                      >
                        <path
                          d="M2 20.5H16C17.103 20.5 18 19.603 18 18.5V4.5C18 3.397 17.103 2.5 16 2.5H14V0.5H12V2.5H6V0.5H4V2.5H2C0.897 2.5 0 3.397 0 4.5V18.5C0 19.603 0.897 20.5 2 20.5ZM2 5.5H16V7.5H2V5.5Z"
                          fill="#ECD996"
                        />
                      </svg>
                    </div>
                  ...
                  <div className="capsule-3">
                    <div className="capsule_logo-2 w-embed">
                      ...
                      >
                        <path
                          d="M12.4997 0.333252C6.06667 0.333252 0.833008 5.56692 0.833008 11.9999C0.833008 18.4329 6.06667 23.6666 12.4997 23.6666C18.9327 23.6666 24.1663 18.4329 24.1663 11.9999C24.1663 5.56692 18.9327 0.333252 12.4997 0.333252ZM16.3415 17.4914L11.333 12.4829V4.99992H13.6663V11.5169L17.9912 15.8418L16.3415 17.4914V17.4914Z"
                          fill="#ECD996"
                        />
                      </svg>
                    </div>
