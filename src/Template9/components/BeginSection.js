        ...
        <div className="padding-global-5">
          <div className="container-large">
            <div className="begin_content-wrapper">
              <div
                data-w-id="118a5668-4540-3f3a-af85-e09563328cf3"
                style={{ opacity: 1 }}
                className="begin_heading-wrapper"
              >
              ...
              <img
                src="https://assets-global.website-files.com/64ede0a591d8114fdaa0ae7f/64f773e883fc6a9a0090466c_Frame.webp"
                loading="lazy"
                alt=""
                className="down-arrow"
              />
              <div
                data-w-id="118a5668-4540-3f3a-af85-e09563328cfb"
                style={{ opacity: 1 }}
                className="begin_video-wrapper"
              >
                <img
                  src="https://assets-global.website-files.com/64ede0a591d8114fdaa0ae7f/64f773e983fc6a9a009046e4_sharan-video.webp"
                  loading="lazy"
                  width="1056"
                  sizes="(max-width: 479px) 100vw, (max-width: 767px) 91vw, (max-width: 1279px) 92vw, 1056px"
                  alt=""
                  ...
                  className="begin_video desktop"
                />
                <img
                  src="https://assets-global.website-files.com/64ede0a591d8114fdaa0ae7f/64f773e983fc6a9a009046eb_Frame%201160444751.webp"
                  loading="lazy"
                  width="1056"
                  sizes="(max-width: 479px) 86vw, 100vw"
                  alt=""
                  srcset="https://assets-global.website-files.com/64ede0a591d8114fdaa0ae7f/64f773e983fc6a9a009046eb_Frame%25201160444751-p-500.png 500w, https://assets-global.website-files.com/64ede0a591d8114fdaa0ae7f/64f773e983fc6a9a009046eb_Frame%201160444751.webp 720w"
                  className="begin_video mobile"
                />
                <a
                  href="https://youtube.com/watch?v=J-DHPt8HU-4"
                  className="play-video w-inline-block w-lightbox"
                >
                  ...
                  <div className="play-button w-embed">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M66 48.5L39.75 63.6554L39.75 33.3446L66 48.5Z"
                        fill="white"
                      />
                    </svg>
                  </div>
